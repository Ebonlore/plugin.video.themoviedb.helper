...
class _TraktLists():
    ...
    @is_authorized
    def get_mixed_list(self, path, trakt_types=[], limit=99, extended=None, authorize=False):
        ...
        if items:
            return random.sample(items, 99)

    @is_authorized
    def get_basic_list(self, path, trakt_type, page=1, limit=99, params=None, sort_by=None, sort_how=None, extended=None, authorize=False, randomise=False):
    ...
    def get_custom_list(self, list_slug, user_slug=None, page=1, limit=99, params=None, authorize=False, sort_by=None, sort_how=None, extended=None, owner=False):
    ...
    def get_sync_list(self, sync_type, trakt_type, page=1, limit=99, params=None, sort_by=None, sort_how=None, next_page=True):
